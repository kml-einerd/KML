...
```css
/* Primárias */
--green-buy: #10B981;      /* Compras / Positivo */
--red-sell: #EF4444;       /* Vendas / Negativo */
--blue-neutral: #3B82F6;   /* Neutro / Info */
--purple-accent: #8B5CF6;  /* Destaque / Fresh Bets */

/* Backgrounds */
--bg-primary: #FFFFFF;
--bg-secondary: #F9FAFB;   /* Cinza claro */
--bg-card: #FFFFFF;

/* Texto */
--text-primary: #111827;   /* Preto / Títulos */
--text-secondary: #6B7280; /* Cinza / Subtexto */
--text-muted: #9CA3AF;     /* Cinza claro / Labels */
...
**Especificações:**
- Background: Gradiente azul/roxo sutil
- Título: Font-weight 700, 32px
- Tabs: Pill buttons com estado ativo
- Sticky no topo ao scrollar

**Streamlit:**
```python
st.title("🎯 Radar Institucional")
selected_month = st.tabs(["Setembro", "Outubro", "Novembro"])
```
